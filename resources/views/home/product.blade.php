                ...
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <form action="{{ route('option') }}" method="POST">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="option" value="crop" id="crop">
                            <label class="form-check-label" for="crop">
                              Crop
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="option" value="animal" id="animal">
            ...
            <div class="owl-carousel product-carousel px-5">
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="{{  asset('home_ui/img/product-1.png') }}">
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="{{ asset('home_ui/img/product-2.png') }}" alt="product-2">
                        <h6 class="mb-3">Organic Vegetable</h6>
                        <h5 class="text-primary mb-0">$19.00</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="{{ asset('home_ui/img/product-1.png') }}" alt="product-1.png">
                        <h6 class="mb-3">Organic Vegetable</h6>
                        <h5 class="text-primary mb-0">$19.00</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="{{ asset('home_ui/img/product-2.png') }}" alt="product-2.png">
                        <h6 class="mb-3">Organic Vegetable</h6>
                        <h5 class="text-primary mb-0">$19.00</h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href=""><i class="bi bi-cart text-white"></i></a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
                        ...
                        <img class="img-fluid" src="{{ asset('home_ui/img/feature.png') }}" alt="feature.png">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="text-white mb-5">
