                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-primary p-4">
                            <div class="d-flex overflow-hidden mb-3">
                                <img class="img-fluid flex-shrink-0" src="{{ asset('/home_ui/img/blog-1.jpg') }}"
                            ...
                            <div class="d-flex overflow-hidden mb-3">
                                <img class="img-fluid flex-shrink-0" src="{{ asset('/home_ui/img/blog-2.jpg') }}"
                                    style="width: 75px;" alt="">
                                <a href=""
                                    class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Lorem ipsum
                                    dolor sit amet elit
                            ...
                            <div class="d-flex overflow-hidden mb-3">
                                <img class="img-fluid flex-shrink-0" src="{{ asset('/home_ui/img/blog-3.jpg') }}"
                                    style="width: 75px;" alt="">
                                <a href=""
                                    class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Lorem ipsum
                                    dolor sit amet elit
